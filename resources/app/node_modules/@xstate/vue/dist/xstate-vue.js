(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('xstate'), require('xstate/lib/behaviors')) :
    typeof define === 'function' && define.amd ? define(['exports', 'vue', 'xstate', 'xstate/lib/behaviors'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.XStateVue = {}, global.Vue, global.XState, global.behaviors));
}(this, (function (exports, vue, xstate, behaviors) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function useService(service) {
        if (process.env.NODE_ENV !== 'production' &&
            !('machine' in (vue.isRef(service) ? service.value : service))) {
